...
au_arma(Arma, ListaNume) :- bagof(Nume, inarmat(Nume, Arma), ListaNume).

au_marca(Marca, ListaNume) :- bagof(Nume, conduce(Nume, Marca), ListaNume).
...
arme_marca(Marca, ListaArme) :- bagof(Arma, Nume ^ (conduce(Nume, Marca), inarmat(Nume, Arma)), ListaArme).
...
suspect1(Nume:Marca:Arma) :-
        ...
        forall(member(A, ListaArme), \+ au_arma(A, [_])).
...
suspect3(Nume:Marca:Arma) :-
        suspect2(Nume:Marca:Arma),
        \+ forall(suspect2(N:_:Arma), N == Nume).
...
suspect4(Nume:Marca:Arma) :-
        suspect3(Nume:Marca:Arma),
        \+ forall(suspect3(N:Marca:_), N == Nume).
...
suspect5(Nume:Marca:Arma) :-
        suspect4(Nume:Marca:Arma),
        forall(suspect4(N:_:Arma), N == Nume).
...
suspect6(Nume:Marca:Arma) :-
        suspect5(Nume:Marca:Arma),
        forall(suspect5(N:Marca:_), N == Nume).
